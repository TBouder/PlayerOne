...
export function ProtocoleUniswap() {
	return (
		<span className={`${badgeClassNames}`} style={{background: 'linear-gradient(128.17deg, rgba(189, 0, 255, 0.2) -14.78%, rgba(255, 31, 138, 0.2) 110.05%)', color: '#BD00FF'}}>
			{'Uniswap'}
		</span>
	);
}
export function ProtocoleSushiswap() {
	return (
		<span className={`${badgeClassNames}`} style={{background: 'radial-gradient(circle at left top, rgba(37, 167, 219, 0.3), rgba(250, 82, 160, 0.3)', color: 'rgb(250, 81, 157)'}}>
			{'Sushiswap'}
		</span>
	);
}
