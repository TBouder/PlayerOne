	...
	return (
		<div className={'relative pt-24'}>
			<div className={'text-lg mx-auto'}>
				...
				<p className="mt-8 text-xl text-gray-500 dark:text-dark-white leading-8">
			...
			<div className={'mt-6 prose-lg prose-accent w-full text-gray-500 dark:text-dark-white mx-auto max-w-full'}>
