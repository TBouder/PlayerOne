...
function	ItemCollection({faIcon, title, content, reward, progress}) {
	return (
		<div className={`relative rounded-lg bg-gray-200 dark:bg-dark-background-600 w-full h-full cursor-pointer group z-10 overflow-hidden transition-colors flex flex-row col-span-full`}>
			<div className={'flex flex-col justify-center items-center p-4 z-10 w-1/6 dark:bg-dark-background-400'}>
			...
			<div className={'flex flex-col px-8 py-4 z-10 w-5/6'}>
				...
				<div className={'flex flex-row justify-between'}>
					<div className={'flex flex-col rounded-md dark:bg-dark-background-600 text-xs'}>
						<span>
					...
					<div className={'flex rounded-md dark:bg-dark-background-600'}>
						<button
							onClick={() => null}
							type={'button'}
							className={'flex flex-row items-center justify-center px-4 py-4 font-medium text-gray-700 hover:text-gray-900 dark:text-dark-background-100 dark:hover:text-white'}>
