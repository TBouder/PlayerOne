...
function	ContextItemClaimed({count}) {
	return (
		<li className={'px-2 py-2 text-gray-400 dark:text-dark-background-600 dark:text-opacity-75 flex items-center hover:bg-gray-200 hover:text-gray-800 cursor-pointer'}>
...
function	ContextItemClaimable({set_modalOpen, count}) {
	return (
		<li
			...
			className={`px-2 py-2 text-gray-400 dark:text-dark-background-600 dark:text-opacity-75 flex items-center hover:bg-gray-200 hover:text-gray-800 ${count > 0 ? 'cursor-pointer' : 'cursor-auto'} relative`}>
	...
	return (
		<>
			...
			{chainID === 524289 || chainID === 80001 || chainID === 3 ? <a
				...
				<li
					onClick={() => set_open(false)}
					className={'transition-all px-2 py-2 text-gray-400 dark:text-dark-background-600 dark:text-opacity-75 flex items-center hover:bg-gray-200 hover:text-gray-800 cursor-pointer'}>
